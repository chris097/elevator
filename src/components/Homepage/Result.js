        ...
        <div className='relative'>
            ...
            <div className='text-white z-40 absolute top-0 px-10 pt-20'>
                ...
                {results.map((result, index) => (
                    <Reveal  key={index}>
                        <div className='bg-primarypink rounded-md lg:h-[280px] lg:py-0 py-4 h-auto gap-1 flex justify-center flex-col items-center'>
                        <svg className='lg:w-[80px] lg:h-[80px] w-[40px] h-[40px]' viewBox="0 0 78 80" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                            ...
                            <p className='text-white lg:text-[40px] mt-4 font-bold text-xl'>{result.number}</p>
                            <p className='lg:text-xl text-sm mt-4 text-white'>{result.title}</p>
                    </div>
                    </Reveal>
                ))}
                </div>
