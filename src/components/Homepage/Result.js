...
const Result = () => {
    return (
        <div className='relative'>
            <div className=''>
                <div className='bg-black absolute opacity-90 w-5/6 z-30 lg:h-[800px] h-[650px]' />
            ...
            <div className='text-white z-40 absolute w-full top-0 px-10 pt-24 font-tillitium'>
                ...
                {results.map((result, index) => (
                    <Reveal  key={index}>
                        <div className='bg-primarypink w-full font-tillitium lg:h-[280px] lg:py-0 py-4 h-auto gap-1 flex justify-center flex-col px-10 mt-10'>
                        <svg className='lg:w-[80px] lg:h-[80px] w-[40px] h-[40px]' viewBox="0 0 78 80" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                            ...
                            <p className='lg:text-lg text-sm md:mt-4 mt-2 font-medium text-white'>{result.title}</p>
                    </div>
                    </Reveal>
                ))}
                </div>
