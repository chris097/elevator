    ...
    return (
        <div className='w-[90%] mx-auto pt-36'>
            <div className='flex'>
                ...
                <div className=' bg-primaryyellow w-[606px] py-20 px-10'>
                    <p className='text-primarypink text-xl font-semibold uppercase'>ABOUT US</p>
                    <p className='text-[38px] font-semibold mt-10'>WE ARE QUALIFIED IN EVERY WORKING DEPARTMENTS</p>
                    <p className='text-[24px] text-[#6E777D] mt-4 mb-7'>Laoreet conubia parturient lacinia pulvinar senectus vel posuere proin nec montes dapibus, elementum blandit sem et massa ornare habitasse cursus erat nascetur, a sed placerat sagittis euismod.</p>
                    {abouts.map((about, index) => (
                        ...
                        <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span className='text-[#6E777D] text-xl'>{about.description}</span>
                    </div>
                    ))}
