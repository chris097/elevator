...
const Testimonies = () => {
    return (
        <div className=' bg-white py-32'>
            <Reveal>
                <div className='py-10 px-16 w-[90%] mx-auto shadow-sm border-t-[0.5px] font-tillitium'>
                <div className='flex'>
                    ...
                    <div className='ml-32'>
                        <Reveal><p className='leading-tight text-primaryblack mt-6 text-2xl w-[90%] font-tillitium text-[36px]'>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p></Reveal>
